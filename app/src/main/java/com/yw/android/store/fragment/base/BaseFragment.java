package com.yw.android.store.fragment.base;
...
public abstract class BaseFragment<V extends IView, M extends IModel> extends RxFragment
    ...
    public void hideSoftKeyBord() {
        ...
        if (v != null) {
            try {
                InputMethodManager e = (InputMethodManager) activity.getSystemService(Context
